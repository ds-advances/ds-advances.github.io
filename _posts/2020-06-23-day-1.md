...
- start: "15.00"
  ...
  title: "Responsible AI for Addressing Human Rights Challenges"
  abstract: "AI has the ability to contribute to solutions addressing some of the world’s greatest societal challenges including climate change, poverty, inequality, and modern slavery. The power of data and ability of AI methodologies to combine multiple sources of under utilised or siloed data to generate insights is increasingly being recognised. New data, especially vast streams of passively collected data can give unprecedented insight into near real-time behaviours and responses to high risk situations. However, the true value and utility of such data and AI methods will only be realised if it is harnessed responsibly. It has been estimated that there are over 40 million people in modern day slavery. In this talk, I discuss the challenges and opportunities that AI has to tackle modern slavery – a human rights challenge – and proposed ingredients and framework needed to create responsible AI innovation and practices across the pipeline from idea generation to implementation."
- start: "15.25"
  end: "15.45"
  author:
  - given: Claire
