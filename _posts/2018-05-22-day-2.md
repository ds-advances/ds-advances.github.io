...
- start: "9:40"
  ...
  abstract:"Large concern by public has emerged recently about social media data can reveal about users. In this talk, some examples are presented of how public social media data could be explored with data science to predict user behaviour and societal trends, including public interest, individual preferences, and personal information. Example studies on the US election, hate-speech, opinion change, and fake accounts are covered in this talk. All analysis are applied on publicly available data, which might give an indication about what could be done further if private data is used."
- start: "10:20"
  title: Coffee
- start: "11:00"
  end: "11.35"
